...
import type { ContentEntry } from "@/backend/repositories/content/repository";
import type { ContentSubtypeRepositoryPort } from "@/backend/repositories/content/subtype-repository";

import { ContentSubtypeService } from "./subtype-service";
