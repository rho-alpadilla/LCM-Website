...
export const metadata = { title: "Giving Confirmation" };
    ...
    <PublicPage>
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        <p className="rounded-2xl border border-slate-200 bg-slate-50 p-6 leading-7 text-slate-700">
          PayMongo may send a payment receipt to the email entered during checkout.
          If you need help, please contact the church with the PayMongo reference.
        </p>
        <Link
