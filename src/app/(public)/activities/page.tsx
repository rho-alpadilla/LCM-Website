...
import { getPublicActivities } from "@/lib/public-content-cache";
import {
  activityTypeLabel,
  formatPublicDate,
...
import { expandUpcomingOccurrences } from "@/server/services/schedule-occurrence-service";
...
export default async function ActivitiesPage() {
  ...
  const occurrences = expandUpcomingOccurrences(activities);
  return (
    <PublicPage>
      <PageIntro
