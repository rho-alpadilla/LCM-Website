...
import { ContentSubtypeEditor } from "@/components/admin/content-subtype-editor";
...
export default async function ContentEditorPage({
  ...
  const repository = new ContentRepository(state.environment.DB);
  const service = new ContentWorkflowService(repository);
  let editor;
  try {
    editor = await service.getForActor(state.context, contentId);
  } catch (error) {
